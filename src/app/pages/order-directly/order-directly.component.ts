...
@Component({
  selector: 'app-order-directly',
  templateUrl: './order-directly.component.html',
  styleUrls: ['./order-directly.component.scss']
})
export class OrderDirectlyComponent implements OnInit {
  quantity: number = 0;
